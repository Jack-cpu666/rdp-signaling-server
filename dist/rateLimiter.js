...
class RateLimiter {
    ...
    checkLimit(clientId, isSuccess = true) {
        const now = Date.now();
    ...
    detectSuspiciousActivity(client, now) {
...
class SocketRateLimiter {
    constructor(globalConfig, eventConfigs) {
        this.eventLimiters = new Map();
    ...
    blacklistSocket(socket, duration) {
        const clientId = this.getClientId(socket);
